...
const keyStrokeSound = new Audio("./public/preview.mp3");
keyStrokeSound.volume = 0.4;
...
function updateTyping() {
  ...
  const wordsTypedValue = textInput.value.trim();
  const wordsTyped =
    wordsTypedValue.length === 0 ? 0 : wordsTypedValue.split(/\s+/).length;
